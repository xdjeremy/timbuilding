...
const components: JSXMapSerializer = {
  heading2: ({ children }) => (
    <h2 className="mb-5 overflow-x-visible overflow-y-visible text-4xl font-extrabold whitespace-normal md:mb-6 md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl">
      {children}
    </h2>
  ),
  heading3: ({ children }) => (
    <h3 className="mb-5 text-xl font-bold break-words whitespace-normal md:mb-6 md:text-2xl md:leading-[1.3] lg:text-3xl">
      {children}
    </h3>
  ),
  strong: ({ children }) => (
    <span className="highlight -mx-[0.1em] inline-block px-[0.1em]">
      {children}
    </span>
  ),
      ...
      <Container>
        <div className="flex flex-col items-center overflow-visible">
          <div className="rb-12 mb-12 text-center md:mb-18 lg:mb-20">
            <div className="relative z-10 w-full max-w-[95vw] px-4 sm:max-w-[90vw] sm:px-6 md:max-w-[80vw] lg:max-w-[70vw] xl:max-w-[60vw]">
              <div className="mb-10">
                <Badge>{badge}</Badge>
              </div>
          ...
          <div className="grid grid-cols-1 items-start justify-center gap-y-12 overflow-visible md:grid-cols-3 md:gap-x-8 md:gap-y-16 lg:gap-x-12">
            <FeatureItem
