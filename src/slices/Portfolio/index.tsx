...
import {HalfBlueWaves2, OutlineSpark3, ThreeCircles, YellowWaves3} from '@/constants/icons';
...
const component: JSXMapSerializer = {
	...
	heading3: ({children}) => (
		<h3 className='font-extrabold mb-2 text-xl font-bold md:text-2xl'>
			{children}
		</h3>
	),
	strong: ({children}) => (
...
const Portfolio: FC<PortfolioProps> = ({ slice }) => {
	...
	return (
		<Bounded
			as='section'
			className='text-brand-dark-blue relative px-[5%] py-28 md:py-24 lg:py-28 border-b-4 border-black'>
				...
				<article className='mb-8 break-inside-avoid'>
					<div className='mb-5 md:mb-6 relative'>
						<PrismicNextImage
							...
							style={{
								boxShadow: `-15px 15px 0px 0px ${project[0]?.shadow_color}`,
							}}
						/>
						<OutlineSpark3
							className='w-[71px]  h-[71px] absolute -top-10 -left-4 md:-top-14 lg:w-[114px] lg:h-[114px] lg:-left-14 lg:-top-20'/>
					</div>
				...
				<article className='mb-8 break-inside-avoid'>
					<div className='mb-5 md:mb-6'>
						<PrismicNextImage
							...
							className='w-[335px] object-cover object-top h-[166px] mx-auto rounded-3xl border-4 border-black md:w-[416px] md:h-[234px]'
							style={{
								boxShadow: `-15px 15px 0px 0px ${project[1]?.shadow_color}`,
							}}
						/>
					</div>
				...
				<article className='mb-8 break-inside-avoid'>
					<div className='mb-5 md:mb-6'>
						<PrismicNextImage
							...
							style={{
								boxShadow: `-15px 15px 0px 0px ${project[2]?.shadow_color}`,
							}}
						/>
					</div>
				...
				<article className='mb-8 break-inside-avoid'>
					<div className='mb-5 md:mb-6'>
						<PrismicNextImage
							...
							className='w-[335px] object-cover object-top h-[166px] mx-auto rounded-3xl border-4 border-black md:w-[416px] md:h-[234px]'
							style={{
								boxShadow: `-15px 15px 0px 0px ${project[3]?.shadow_color}`,
							}}
						/>
					</div>
				...
				<article className='mb-8 break-inside-avoid'>
					<div className='mb-5 md:mb-6'>
						<PrismicNextImage
							...
							className='w-[335px] object-cover object-top h-[166px] mx-auto rounded-3xl border-4 border-black md:w-[416px] md:h-[234px]'
							style={{
								boxShadow: `-15px 15px 0px 0px ${project[4]?.shadow_color}`,
							}}
						/>
					</div>
				...
				<article className='mb-8 break-inside-avoid'>
					<div className='mb-5 md:mb-6 relative'>
						<PrismicNextImage
							...
							className='w-[335px] object-cover object-top h-[166px] mx-auto rounded-3xl border-4 border-black md:w-[416px] md:h-[234px]'
							style={{
								boxShadow: `-15px 15px 0px 0px ${project[5]?.shadow_color}`,
							}}
						/>
						<ThreeCircles
							name='ThreeCircles'
							className='w-[100px]  h-[280px] absolute bottom-[34%] -right-4 -z-10 md:-right-8 md:-bottom-32 lg:h-[336px] lg:bottom-[2%] lg:-right-12 lg:z-10'
						/>
					</div>
			...
			<footer className='mt-8 flex justify-center md:mt-18 lg:mt-20 relative'>
				<OutlineSpark3
					className='w-[52px]  h-[52px] absolute right-32 bottom-10 -z-10 lg:w-[82px] lg:h-[82px] lg:right-1/4 '/>
			</footer>
			<HalfBlueWaves2
				className='w-[182px]  h-[100px] absolute top-15 right-8 -z-10 lg:w-[250px] lg:h-[180px] lg:right-28'/>
			<OutlineSpark3 className='w-[35px]  h-[35px] absolute top-24 left-16 lg:w-[62px] lg:h-[62px] lg:left-1/3'/>
			<OutlineSpark3
				className='w-[48px]  h-[48px] absolute top-1/3 right-2 lg:w-[62px] lg:h-[62px] lg:top-1/4 lg:right-6'/>
			<OutlineSpark3
				className='w-[42px]  h-[42px] absolute bottom-20 left-6 lg:w-[62px] lg:h-[62px] lg:bottom-32 lg:left-36'/>
			<OutlineSpark3
				className='w-[160px] h-[120px] absolute bottom-0 -z-10 lg:w-[230px] lg:h-[190px] lg:left-40'/>
			<OutlineSpark3
				className='w-[85px]  h-[85px] absolute right-4 bottom-2 lg:w-[139px] lg:h-[139px] lg:right-2'/>
			<OutlineSpark3 className='w-[49px]  h-[49px] absolute top-[70%] -left-4 lg:w-[75px] lg:h-[75px]'/>
			<YellowWaves3
				className='w-[160px] h-[120px] absolute -bottom-24 -z-10 lg:w-[230px] lg:h-[190px] lg:left-40'/>
		</Bounded>
	);
};
