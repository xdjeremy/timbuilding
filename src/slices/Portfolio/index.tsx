	...
	return (
		<Bounded as='section'>
			<Container>
				...
				<HalfBlueWaves2 className='w-[182px]  h-[100px] absolute top-15 right-8 -z-10 lg:w-[250px] lg:h-[180px] lg:right-28' />
				...
				<YellowWaves3 className='w-[160px] h-[120px] absolute -bottom-24 -z-10 lg:w-[230px] lg:h-[190px] lg:left-40' />
			</Container>
		</Bounded>
	);
};
