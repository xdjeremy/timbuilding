...
const components: JSXMapSerializer = {
  ...
  strong: ({ children }) => (
    <span className="bg-brand-blue text-white pb-1 px-1">{children}</span>
  ),
      ...
      <Container>
        ...
        border-black -right-12 top-30"
            ...
            <PrismicNextImage
              ...
              className="w-full xl:w-[616px] xl:h-[640px] object-cover neobrutalist-shadow"
            />
          </div>
        </div>
      </Container>
      <div className="bg-brand-amber h-2/6 -z-20 w-screen absolute bottom-0 right-0 border-t-4 border-black md:h-full md:w-2/5 md:border-t-0 md:border-l-4 "></div>
    </Bounded>
  );
};
