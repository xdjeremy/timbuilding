...
export const HeroImageGrid = ({ images }: HeroImageGridProps) => {
  ...
  return (
    <div className='relative h-[30rem] overflow-hidden pl-[5vw] pr-0 md:h-[40rem] lg:h-screen lg:pl-0'>
      <div className='z-20 grid w-full grid-cols-2 gap-x-4'>
        <div className='-mt-[120%] ml-3 grid size-full animate-loop-vertically columns-2 grid-cols-1 gap-4 self-center'>
        ...
        <div className='ml-4 grid size-full animate-loop-vertically grid-cols-1 gap-4'>
      ...
      {/* bg */}
      <div className='absolute inset-0 -z-10 w-1/2 md:w-3/4 ml-auto border-l-4 border-black bg-black/10 '></div>
    </div>
  );
};
